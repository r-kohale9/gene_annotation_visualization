...
class ChartView extends React.Component {
  ...
  render() {
    ...
    const populateGraph = geneData => {
      ...
      drugInteractions &&
        drugInteractions.map((drugInteraction, key) => {
          const { modifiedString, spaceCount, longestWordLength } =
            drugInteraction.drugName !== '' ? chunk(drugInteraction.drugName) : chunk(drugInteraction.drugClaimName);
          elements.push({
            data: {
